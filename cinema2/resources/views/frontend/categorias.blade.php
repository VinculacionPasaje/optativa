...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
                ...
                @if(count($categoria_peliculas_series))
                                                    
                @foreach($categoria_peliculas_series as $peli)

                    <h4 class="latest-text w3_latest_text">Peliculas de Categoria : {{$peli->categorie}}</h4>
        ...
        @if(Auth::guest())
           ...
           <div class="alert alert-danger alert-dismissable">
				<p style="font-size: 20px;"><strong>! Usted no a iniciado sesión ¡</strong> Solamente se le mostrará un número limitado de películas, para ver todo el contenido debe iniciar sesión, hágalo dando click aqui -> <a href="{{ url('/login') }}" class="alert-link">Login</a> 
				o creese una cuenta dando click aqui -> <a href="{{ url('/register') }}" class="alert-link">Registrarse</a> </p>
			</div>

            @if(count($movies_guest))
                                                    
                @foreach($movies_guest as $peli)
        ...
        <div class="col-md-12">
         ...
         @if(count($categoria_peliculas_series))
                ...
                @foreach($categoria_peliculas_series as $peli)
                    ...
                    <h4 class="latest-text w3_latest_text">Series de Categoria : {{$peli->categorie}}</h4>
